//
//  DeliveryChickenViewController.swift
//  HandongAppSwift
//
...
class DeliveryChickenViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
